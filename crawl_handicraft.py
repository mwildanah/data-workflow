...
df = pd.DataFrame()
material_bangunan = ['asbes','baja','batako','batu','batu%20bata','besi','beton','engsel','gagang%20Pintu','gembok','genteng','granit','grendel','jendela','kaca','kawat','kayu','keramik%20lantai','kusen%20pintu','lantai%20kayu','paku','pasir','semen','tanah','triplek']
